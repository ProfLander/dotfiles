#+TITLE: Linux Init File

#+PROPERTY: header-args :tangle init-linux.el
...
(use-package dat
  ...
  :custom
  (dat-credentials-email "work.josh.p@gmail.com")
  :config
  (setq dat-credentials-pass-function
        (dat-credentials-pass-store "Business/Accounts/DataAnnotation")))
#+end_src
...
#+RESULTS:
: [nil 26661 63281 974334 nil elpaca-process-queues nil nil 16000 nil]
